-- Folded in from shared/migrations/002_add_pgvector_news.sql so this table
-- is tracked by the Supabase CLI like everything else instead of living in
-- an untracked sibling folder. Idempotent: safe to run even if this was

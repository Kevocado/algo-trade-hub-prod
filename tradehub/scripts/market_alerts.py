...
def run_all_alerts():
    ...
    # 1. GEX Flip
    try:
        from tradehub.core.feature_engineering import calculate_gex
    ...
    # 2. VIX Emergency
    try:
        from tradehub.core.data_loader import get_macro_data
    ...
    # 3. Weather Auto-Sell
    try:
        from tradehub.scripts.weather_auto_sell import run_auto_sell_check

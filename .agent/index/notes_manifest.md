...
| --- | --- | --- | --- | --- | --- | --- |
| `.agent/buffer/session_logs.md` | unknown | note | unclassified | unspecified | Session Logs |  |
| `.agent/rules/context_hygiene.md` | unknown | note | unclassified | unspecified | Context Hygiene Rules |  |
| `.agent/rules/execution_safety.md` | unknown | note | unclassified | unspecified | Execution Safety Rules |  |
| `.agent/rules/hygiene.md` | unknown | note | unclassified | unspecified | Global Hygiene Rules |  |
| `.agent/templates/note_frontmatter_example.md` | weather | api_spec | active | unspecified | Open-Meteo Ensemble API | weather, api, open-meteo |
| `.agents/skills/hf-cli/SKILL.md` | unknown | note | unclassified | unspecified | Command Line Interface (CLI) |  |

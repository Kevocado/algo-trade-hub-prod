...
| 8 | `labor_nowcast` (KXPAYROLLS) + Jobs Scorecard (`/jobs`) | 🟢 plan written + verified; implement after PR #3/#4 + 2b (and ideally 6) merge. Backtest roughly ties Kalshi on error (68.5k vs 68.5k) but loses on Brier (0.179 vs 0.166), so it ships as shadow | [2026-09-25-labor-nowcast-jobs-scorecard.md](2026-09-25-labor-nowcast-jobs-scorecard.md) |
